    ...
    def acl_setuser(
        ...
        **kwargs,
        ...
        Args:
            ...
            enabled: Indicates whether the user should be allowed toAuthenticate.
                     Defaults to `False`.
            nopass: Indicates whether the user can Authenticatewithout a password.
...
class ManagementCommands(CommandsProtocol):
    ...
    def auth(self, password: str, username: Optional[str] = None, **kwargs):
       ...
       Authenticates the user. If you do not pass username, Redis will try to
        Authenticatefor the "default" user. If you do pass username, it will
        Authenticatefor the given user.
    ...
    def migrate(
        ...
        **kwargs,
        ...
        If ``auth`` is specified, Authenticateto the destination server with
