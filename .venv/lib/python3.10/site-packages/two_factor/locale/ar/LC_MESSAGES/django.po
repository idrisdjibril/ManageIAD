...
msgstr "جاري الإتصال بكم حاليا, الرجاء إدخال الأرقام التي سوف تسمعها."
...
msgstr "تم إرسال رسالة نصية لك, الرجاء أدخال رمز التفويض الذي تم إرساله."

#: templates/two_factor/core/login.html:17
msgid "Please enter the tokens generated by your token generator."
msgstr "الرجاء إدخال رمز التفويض الذي تم إنشاؤه من خلال تطبيق إنشاء الرموز الخاص بك."
