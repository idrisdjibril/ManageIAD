...
msgstr "A página solicitada, força os usuários a autenticar usando verificação em duas etapas por questões de segurança. Você precisa habilitar esses recursos de segurança a fim de acessar esta página."
