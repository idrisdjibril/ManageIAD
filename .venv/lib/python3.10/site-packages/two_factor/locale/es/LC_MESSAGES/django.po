...
msgstr "El código introducido no es válido."
...
msgstr "No preguntar de nuevo en este dispositivo por %(minutes)iminutos"

#: forms.py:146
#, python-format
msgid "Don't ask again on this device for %(hours)i hours"
msgstr "No preguntar de nuevo en este dispositivo por %(hours)ihoras"

#: forms.py:149
#, python-format
msgid "Don't ask again on this device for %(days)i days"
msgstr "No preguntar de nuevo en este dispositivo por %(days)i días"
...
msgstr "Le enviamos un correo electrónico, ingrese el código que le hemos enviado."
...
msgstr "Estamos llamando a su teléfono en este momento. Por favor ingrese los dígitos que escucha."
...
msgstr "Introduce el código generado por tu generador de códigos"

#: plugins/registry.py:70
msgid "Please enter the token generated by your token generator."
msgstr "Por favor, introduce el código generado por tu generador de códigos."

#: plugins/webauthn/forms.py:102
msgid "WebAuthn Token"
msgstr "Código WebAuthn"
...
msgid " Authenticateusing a WebAuthn-compatible device"
msgstr "Usa un dispositivo compatible con WebAuthn para autenticarte"

#: plugins/webauthn/method.py:65
msgid "Please use your WebAuthn-compatible device toAuthenticate."
msgstr "Por favor, utiliza tu dispositivo compatible con WebAuthn para autenticarte."
...
msgstr "Los códigos de respaldo se pueden usar cuando sus números de teléfono principal y secundario no están disponibles. Los tokens de respaldo a continuación se pueden usar para verificar el inicio de sesión. Si ha agotado todos sus códigos de respaldo, puede generar un nuevo conjunto de tokens de respaldo. Solo serán válidos los códigos de respaldo que se muestran a continuación."
...
msgstr "Todavía no tienes ningún código de respaldo."
...
msgstr "Generar Códigos de Respaldo"
...
msgstr "Utilice este formulario para ingresar códigos de respaldo para iniciar sesión. Estos códigos se han generado para que los imprima y los guarde. Ingrese uno de estos códigos de respaldo para iniciar sesión en su cuenta."

#: templates/two_factor/core/login.html:29
msgid "Or, alternatively, use one of your other authentication methods:"
msgstr "O, alternativamente, utilice otro método de autenticación:"

#: templates/two_factor/core/login.html:48
msgid "As a last resort, you can use a backup token:"
msgstr "Como último recurso, puede utilizar un código de respaldo:"

#: templates/two_factor/core/login.html:51
msgid "Use Backup Token"
msgstr "Usa un Código de Respaldo"
...
msgstr "La página que solicitó obliga a los usuarios a verificar mediante autenticación de dos factores por razones de seguridad. Debe habilitar estas funciones de seguridad para acceder a esta página."
...
msgstr "La autenticación de dos factores no está habilitada para su cuenta. Habilite la autenticación de dos factores para mejorar la seguridad de la cuenta."
...
msgstr "Agregará un número de teléfono de respaldo a su cuenta. Este número se utilizará si su método principal de autentificación no está disponible."

#: templates/two_factor/core/phone_register.html:12
msgid ""
"We've sent a token to your phone number. Please enter the token you've "
"received."
msgstr "Hemos enviado un código a su número de teléfono. Ingrese el código que recibió."
...
msgstr "Está a punto de llevar la seguridad de su cuenta al siguiente nivel. Siga los pasos de este asistente para habilitar la autenticación de dos factores."

#: templates/two_factor/core/setup.html:15
msgid "Please select which authentication method you would like to use."
msgstr "Seleccione el método de autenticación que desea utilizar."
...
msgstr "Para empezar a utilizar un generador de códigos, por favor utilice su smartphone para escanear el código QR ​​a continuación. Por ejemplo, utilice Google Authenticator."
...
msgstr "Como alternativa puede usar el siguiente código secreto para configurar TOTP manualmente en su autenticador o administrador de contraseñas."
...
msgstr "Luego introduzca el código generado por dicha aplicación."
...
msgstr "Ingrese el número de teléfono en el que desea recibir los mensajes de texto. Este número se validará en el siguiente paso."
...
msgstr "Introduzca el número de teléfono al que desea que le llamen. Este número se validará en el siguiente paso."

#: templates/two_factor/core/setup.html:40
msgid "We sent you a text message, please enter the tokens we sent."
msgstr "Le enviamos un mensaje de texto, ingrese el código que le hemos enviado."
...
msgstr "Hemos detectado un problema con el método de autenticación seleccionado. Regrese y verifique que ingresó su información correctamente, vuelva a intentarlo o utilice un método de autenticación diferente. Si el problema persiste, comuníquese con el administrador del sitio."
...
msgstr "Para identificar y verificar su YubiKey, ingrese un código en el campo a continuación. Su YubiKey se vinculará a su cuenta."

#: templates/two_factor/core/setup_complete.html:7
msgid ""
"Congratulations, you've successfully enabled two-factor authentication."
msgstr "Felicitaciones, ha habilitado con éxito la autenticación de dos factores."
...
msgstr "Sin embargo, puede suceder que no tenga acceso a su dispositivo principal. Para habilitar la recuperación de la cuenta, agregue un número de teléfono."
...
msgstr "Está a punto de desactivar la autenticación de dos factores. Esto debilita la seguridad de su cuenta, ¿está seguro?"
...
msgstr "Si su método principal de autentificación no está disponible, podemos enviar códigos de respaldo a los números de teléfono que se enumeran a continuación."
...
"backup tokens."
msgstr "Si no tiene ningún dispositivo con usted, puede acceder a su cuenta usando códigos de respaldo."
...
msgstr[0] "Le queda un solo código de respaldo."
msgstr[1] "Le quedan %(counter)s de códigos de respaldo."
msgstr[2] "Le quedan %(counter)s códigos de respaldo."
...
msgstr "Sin embargo, le desaconsejamos encarecidamente que lo haga, también puede desactivar la autenticación de dos factores para su cuenta."

#: templates/two_factor/twilio/sms_message.html:2
#, python-format
msgid "Your OTP token is %(token)s"
msgstr "Su código OTP es %(token)s"

#: views/core.py:274
msgid "Your session has timed out. Please login again."
msgstr "Su sesión ha expirado. Ingrese nuevamente."
