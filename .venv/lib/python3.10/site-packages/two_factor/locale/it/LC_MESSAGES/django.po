...
"Last-Translator: Mij M, 2022\n"
"Language-Team: Italian (http://app.transifex.com/Bouke/django-two-factor-auth/language/it/)\n"
"MIME-Version: 1.0\n"
...
msgstr "Non chiedere più su questo dispositivo per %(minutes)i minuti"

#: forms.py:146
#, python-format
msgid "Don't ask again on this device for %(hours)i hours"
msgstr "Non chiedere più su questo dispositivo per %(hours)i ore"

#: forms.py:149
#, python-format
msgid "Don't ask again on this device for %(days)i days"
msgstr "Non chiedere più su questo dispositivo per %(days)i giorni"
