...
"Language-Team: German (http://app.transifex.com/Bouke/django-two-factor-auth/language/de/)\n"
"MIME-Version: 1.0\n"
...
msgstr "Wir haben Ihnen eine Email gesendet. Bitte tragen Sie das Token ein, das Sie erhalten haben."
...
msgstr "Wir haben Ihnen eine SMS gesendet. Bitte tragen Sie das Token ein, das Sie erhalten haben."
...
msgstr "Wir rufen Sie gerade an, bitte geben Sie die Zahlen ein, die Sie hören. "
...
msgstr "Bitte geben Sie das Token ein, das von Ihrem Token-Generator erzeugt wurde."
...
msgstr "Ersatz-Tokens können verwendet werden, sollte ihre andere Authentifizierungsmethode nicht zur Hand sein. Die Ersatz-Tokens unten können verwendet werden um sich später einzuloggen. Wenn alle Ersatz-Tokens verbraucht sind, können Sie neue generieren. Nur die Ersatz-Tokens werden unten gezeigt. "
...
msgstr "Benutzen Sie dieses Formular um ihre Ersatz-Tokens einzugeben und sich einzuloggen. "

#: templates/two_factor/core/login.html:29
msgid "Or, alternatively, use one of your other authentication methods:"
msgstr "Oder nutzen Sie alternativ eine ihrer anderen Authentifikationsmethoden."
...
msgstr "Die angeforderte Seite erwartet eine Verifizierung mit Two-Factor Authentifizierung. Sie müssen diese Sicherheitsfunktion aktivieren, um Zugriff zu erhalten. "
...
msgstr "Two-Factor Authentifizierung ist nicht aktiviert für Ihren Account. Aktivieren Sie jetzt Two-Factor Authentifizierung um die Sicherheit Ihres Accounts zu erhöhen. "
...
msgstr "Sie fügen eine Backup-Telefonnummer zu ihrem Account hinzu. Diese Nummer wird verwenden, sollte ihre andere Authentizierungsmethode nicht verfügbar sein. "

#: templates/two_factor/core/phone_register.html:12
msgid ""
"We've sent a token to your phone number. Please enter the token you've "
"received."
msgstr "Wir haben Ihnen einen Token auf Ihr Telefon gesendet. Bitte geben Sie den Token ein. "
...
msgstr "Two-Factor Authentifizierung verbessert die Sicherheit ihres Accounts erheblich. Bitte folgen Sie der Schritt-für-Schritt Anleitung."
...
msgstr "Um einen Token-Generator zu nutzen, scannen Sie bitte mit Ihrem Smartphone den QR-Code unten. Verwenden Sie hierfür eine Authenticator App, beispielsweise Google Authenticator."
...
msgstr "Alternativ können Sie den folgenden Geheimschlüssel verwenden, um TOTP in Ihrem Authenticator oder Passwort-Manager manuell einzurichten."
...
msgstr "Bitte geben Sie die Telefonnummer ein, an die wir die SMS senden sollen. Diese Nummer wird im nächsten Schritt validiert. "
...
msgstr "Bitte geben Sie die Rufnummer an, unter der wir Sie anrufen sollen. Diese Nummer wird im nächsten Schritt überprüft. "
...
msgstr "Wir haben ein Problem mit der ausgewählten Authentifizierungsmethode entdeckt. Bitte gehen sie zurück, kontrollieren sie die Angaben und probieren Sie es erneut. Alternativ können Sie eine andere Authentifizierungsmethode verwenden. Wenn das Problem weiterhin besteht, kontaktieren Sie bitte den administrateur. "
...
msgstr "Bitte geben Sie den Token im unteren Feld an, um ihren Yubikey zu identifizieren und zu verifizieren. Ihr YubiKey wird mit dem Account verbunden. "

#: templates/two_factor/core/setup_complete.html:7
msgid ""
"Congratulations, you've successfully enabled two-factor authentication."
msgstr "Herzlichen Glückwunsch, Sie haben erfolgreich die Zweifaktoren-Authentifizierung aktiviert."
...
msgstr "Es kann passieren, dass Sie keinen Zugriff auf ihren primären Token haben. Um die Wiederherstellung ihres Accounts sicherzustellen, geben Sie bitte eine Telefonnummer an. "
...
msgstr "Sie sind dabei die Zweifaktoren Authentifizierung zu deaktivieren. Dies schwächt die Sicherheit ihres Accounts. Sind Sie sicher?"
...
msgstr "Wenn ihre primäre Authentifizierungsmethode nicht zur Verfügung steht, können wir ihnen Ersatz-Tokens an die Telefonnummern unten senden. "
...
"backup tokens."
msgstr "Wenn Sie kein Gerät bei sich haben sollten, dann können Sie einen Backup Token zum Login verwenden. "
...
msgstr "Wir raten Ihnen davon ab die Two-Factor Authentifizierung zu deaktivieren, aber Sie können sie jederzeit deaktivieren. "
