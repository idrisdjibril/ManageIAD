...
"Last-Translator: Steven Roodhorst, 2023\n"
"Language-Team: Dutch (http://app.transifex.com/Bouke/django-two-factor-auth/language/nl/)\n"
"MIME-Version: 1.0\n"
...
msgstr "Vraag mij niet meer op dit apparaat voor %(minutes)i minuten"

#: forms.py:146
#, python-format
msgid "Don't ask again on this device for %(hours)i hours"
msgstr "Vraag mij niet meer op dit apparaat voor %(hours)i uur"

#: forms.py:149
#, python-format
msgid "Don't ask again on this device for %(days)i days"
msgstr "Vraag mij niet meer op dit apparaat voor %(days)i dagen"
...
msgstr "Stuur email naar %s"

#: plugins/email/method.py:44
msgid "We sent you an email, please enter the token we sent."
msgstr "We hebben u een email gestuurd. Vul de token in die we gestuurd hebben."
...
msgstr "We hebben u een tekstbericht gestuurd. Vul de token in die we gestuurd hebben."
...
msgstr "Vul de token in die gegenereerd is door uw tokengenerator."

#: plugins/registry.py:70
msgid "Please enter the token generated by your token generator."
msgstr "Vul de token in die gegenereerd is door uw tokengenerator alstublieft."
...
msgstr "Authentiseer met uw WebAuthn-compatibele apparaat."

#: plugins/webauthn/method.py:65
msgid "Please use your WebAuthn-compatible device toAuthenticate."
msgstr "Gebruik uw WebAuthn-compatibele apparaat om te authenticeren."
...
msgstr "Gebruik uw Yubikey apparaat."
...
msgstr "Of gebruik een alternatieve Authenticatemethode:"
...
msgstr "Om een tokengenerator te gebruiken, gebruikt u uw smartphone om de onderstaande QR-code te scannen. Gebruik bijvoorbeeld Google Authenticator."
...
msgstr "Als alternatief kunt u het volgende geheim gebruiken om TOTP handmatig in te stellen in uw authenticator of wachtwoordbeheerder."
