...
"Last-Translator: Asura Class <asuraclass01@gmail.com>\n"
...
msgstr "มีบัญชีที่ใช้อีเมลนี้แล้ว โปรดลงชื่อเข้าใช้ก่อนแล้วค่อยเชื่อมต่อกับบัญชี ของคุณ"
...
"enter it soon."
msgstr "เราได้ส่งรหัสไปยังลิงก์ทางอีเมลแล้ว รหัสจะหมดอายุ นี้ ดังนั้นโปรดป้อน นี้"
...
msgstr ""
"คุณได้รับอีเมลนี้เนื่องจากคุณหรือบุคคลอื่นพยายามสมัครใช้งาน บัญชีโดยใช้ที่อยู่อีเมล: %(อีเมล)s "
"อย่างไรก็ตามมีบัญชีที่ใช้ที่อยู่อีเมลนั้นอยู่แล้ว ในกรณีที่คุณมี ลืมเรื่องนี้ "
"โปรดใช้ขั้นตอนการลืมรหัสผ่านเพื่อกู้คืน บัญชีของคุณ: %(รหัสผ่าน_รีเซ็ต_url)s"
...
"\n"
"คุณได้รับอีเมลนี้เนื่องจากผู้ใช้ %(user_display)s ใน %(site_domain)s "
"ได้ให้ที่อยู่อีเมลของคุณเพื่อเชื่อมต่อบัญชีของตน\n"
"\n"
"หากต้องการยืนยันว่าข้อมูลนี้ถูกต้อง โปรดไปที่ %(activate_url)s\n"
"ลงทะเบียนบัญชีใน %(site_domain)s"
...
"account."
msgstr ""
"บัญชีโซเชียลไม่สามารถยืนยัน %(อีเมล)s ได้เนื่องจากมีการเชื่อมโยงกับบัญชีอื่นที่ได้รับการยืนยันแล้ว"
