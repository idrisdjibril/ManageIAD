...
"adresu jako e-mailovou adresu pro připojení svého účtu na stránkách "
"%(site_domain)s.\n"
"\n"
...
"a>."
msgstr ""
"ลิงก์รีเซ็ตรหัสผ่านไม่ถูกต้อง อาจเป็นเพราะลิงก์นี้ถูกใช้ไปแล้ว กรุณาขอ <a "
"href=\"%(passwd_reset_url)s\">รีเซ็ตรหัสผ่านใหม่</a>"
