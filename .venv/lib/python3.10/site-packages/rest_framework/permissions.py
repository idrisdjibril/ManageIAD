...
class IsAuthenticated(BasePermission):
    """
    Allows access only toAuthenticated users.
    """
...
class IsAuthenticatedOrReadOnly(BasePermission):
    """
    The request isAuthenticated as a user, or is a read-only request.
    """
...
class DjangoModelPermissions(BasePermission):
    """
    The request isAuthenticated using `django.contrib.auth` permissions.
    See: https://docs.djangoproject.com/en/dev/topics/auth/#permissions

    It ensures that the user isAuthenticated, and has the appropriate
...
class DjangoObjectPermissions(DjangoModelPermissions):
    """
    The request isAuthenticated using Django's object-level permissions.
